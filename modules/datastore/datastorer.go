...
type DataStorer interface {
  ...
  // List by...
	...
	GetBooksByAuthorID(authorID uint, noDetails bool, page int, per_page int, params models.Search) (*paginate.PaginatedList, error)
	GetBooksBySerieID(authorID uint, noDetails bool, page int, per_page int, params models.Search) (*paginate.PaginatedList, error)
	GetBooksByGenreID(genreID uint, noDetails bool, page int, per_page int, params models.Search) (*paginate.PaginatedList, error)
