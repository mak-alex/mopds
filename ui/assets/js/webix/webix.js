...
window.webix || (webix = {}), webix.version = "5.1.0", webix.codebase = "./", webix.name = "core", webix.cdn = "//cdn.webix.com", webix.clone = function(t) {
    ...
    function(t) {
        ...
        function i(t) {
            ...
            function s(t, e, i, s) {
                if (2 == h) return s();
                if ("object" != typeof l && "function" != typeof l || "function" != typeof t) s();
                else try {
                    var n = 0;
                    t.call(l, function(t) {
                        n++ || (l = t, e())
    ...
    function() {
        ...
        destructor: function() {
            ...
            if (this.di && this.editCancel(), this.callEvent && this.callEvent("onDestruct", []),
                this.destructor = function() {}, this.VE.obj = null, this.getChildViews) {
        ...
        result: function(t, e, i, s, n, r) {
            ...
            for (var o = [], h = 0; h < a.length; h++) {
                ...
                o.push(l), l.status = l.type,
                    l.id = l.sid, l.newid = l.tid, i.processResult(l, l, {
                        text: s,
                        data: n,
                        loader: r
                    })
    ...
    webix.ValueBind = {
        ...
        webix.UIManager.ob(), webix.UIManager.addHotKey("enter", function(t, e) {
            if (t && t.callEvent && t.callEvent("onEnter", [e]), t && t.editStop && t.Eb) return t.editStop(), !0;
            if (t && t.touchable) {
                var i = t.getFormView();
    ...
    function() {
        ...
        if (!webix.ui) {
            e = webix.ui = function(t, n, r) {
                ...
                if (t.s || o && a ? h = t : (o && l && (t.$topView = !0), t.Ob || (t.Ob = {}), h = e.A(t)), !l || h.setPosition || h.$apiOnly || webix.ui.Pb(), h.s && h.s.ft && !o.$view) h.s.gt = o;
                    ...
                    var c = o;
                    if (r || 0 === r || webix.isArray(h) || (r = o, o = o.getParentView()), o && o.Qb) h.getParentView && h.getParentView() && h.getParentView().Rb(h), o.Qb(h, r);
                    else {
        ...
        webix.ui.animate = function(t, e, i) {
                ...
                webix.html.addStyle("html, body{ height:100%; }"),
                    document.body.className += " webix_full_screen", webix.ui.Pb = function() {}, webix.Touch.limit(!1)
                ...
                if (webix.UIManager.applyChanges(), webix.callEvent("onClick", []), webix.ui.QG = !0, !webix.ui.PG)
                    for (var e = t.length - 1; e >= 0; e--) t[e].obj && t[e].obj.resize();
                webix.ui.QG = !1
                ...
                $init: function(t) {
                    t.id || (t.id = webix.ui.Tb(this.name)), this.Xb = webix.Xb, webix.Xb = null, this.$scope = t.$scope || (this.Xb ? this.Xb.$scope : null),
                        this.x || (this.w = this.x = webix.html.create("DIV", {
                            "class": "webix_view"
                        }), this.$view = this.x)
                },
                $skin: !1,
                ...
                queryView: function(t, e) {
                    ...
                    if ("object" == typeof t) {
                        ...
                        var i = function(t) {
                            for (var e = t.config, i = 0; i < s.length; i++)
                                if (e[s[i]] != n[i]) return !1;
                            return !0
                        }
                    } else i = t;
                    var a = "all" === e ? [] : !1,
                        o = "parent" === e ? this.gG : this.hG,
                        h = this.iG(i, o, a);
                    return "all" === e ? a : h
                },
                hG: function(t) {
                ...
                iG: function(t, e, i) {
                    for (var s = e(this), n = 0; n < s.length; n++)
                        if (t(s[n])) {
                            if (!i) return s[n];
                            i.push(s[n]);
                        } else {
                ...
                disable: function() {
                    webix.html.remove(this.$b), this.s.disabled = !0, this.$b = webix.html.create("div", {
                        ...
                        }), window.getComputedStyle && (this._b = window.getComputedStyle(this.x, null).getPropertyValue("position")), "absolute" != this._b && (this.x.style.position = "relative"),
        ...
        resizeChildren: function() {
            if (!webix.ui.PG && this.lc) {
                ...
                if (s = e = this.lc[0] || 0, n = i = this.lc[1] || 0,
                    (r[1] >= 1e5 || r[3] >= 1e5) && this.x.parentNode && (s = e = Math.max(r[0], this.s.width || this.x.parentNode.offsetWidth || e || 0), n = i = Math.max(r[2], this.s.height || this.x.parentNode.offsetHeight || i || 0)), t) this.rc(e, i);
                else {
                    r[0] > e && (s = r[0]), r[2] > i && (n = r[2]);
                    var a = this.x.parentNode == document.body && !this.setPosition;
                    !a && e > r[1] && (s = r[1]), !a && i > r[3] && (n = r[3]), this.$setSize(s, n)
                }
    ...
    webix.protoUI({
        ...
        return "top" == s || "bottom" == s ? (t.style.left = "0px", t.style.top = (i.top || n) + ("top" == s ? 1 : -1) * e.offsetHeight + "px") : (t.style.top = (i.top || 0) + "px",
            t.style.left = n + ("left" == s ? 1 : -1) * e.offsetWidth + "px"), e.parentNode == t.parentNode && i.keepViews ? t.style.display = "" : webix.html.insertBefore(t, e.nextSibling, e.parentNode), "slide" == i.type && "out" == i.subtype && (t.style.left = "0px", t.style.top = (i.top || 0) + "px", e.parentNode.removeChild(e), webix.html.insertBefore(e, t.nextSibling, t.parentNode)), [t, e]
        ...
        $init: function(t) {
            t = t || {}, this.Oc = 0, this.Pc = 300, this.Qc = null, this.Rc(t.onClick, "on_click"), this.Rc(t.onContext, "on_context"), this.Rc(t.onDblClick, "on_dblclick"), this.Rc(t.onMouseMove, "on_mouse_move"),
                this.on_click && (webix.UE(this.w, "click", this.Sc, {
                    bind: this
        ...
        Vc: function() {
            this.Wc || (this.on_mouse_move = this.on_mouse_move || {},
                webix.UE(this.w, "mousemove", this.Xc, {
                    bind: this
    ...
    webix.protoUI({
        ...
        addDrag: function(t, e) {
            t = webix.toNode(t),
                t.webix_drag = this.qd(e), webix.UE(t, webix.env.mouse.down, this.rd, {
                    bind: t
        ...
        createDrag: function(t) {
            ...
            return s.style.zIndex = Math.max(s.style.zIndex, webix.ui.zIndex()), webix.DragControl.Hd = webix.event(s, webix.env.mouse.move, webix.DragControl.Id),
                webix.DragControl.Gd.from || (webix.DragControl.Gd = {
                    source: i,
                    from: i
        ...
        Rd: function(t, e, i, s) {
            this.Sd(), document.body.appendChild(this.$d = webix.html.create("DIV", {
                ...
                }, "")), this.$d.style.zIndex = webix.ui.zIndex(), this.$d.style.position = s ? "fixed" : "absolute",
        ...
        Zz: function() {
            if (!this.$z) {
                ...
                t.firstChild && (t = t.firstChild, t.style.position = "relative"),
                    ...
                    }), t.appendChild(this.$z), webix.UE(this.$z, webix.env.mouse.down, this._z, {
                        bind: this
                    })
            }
        },
        ...
        _z: function(t) {
            this.config.resize && (webix.html.addCss(document.body, "webix_noselect webix_resize_cursor"), this.cA = webix.html.offset(this.x),
                this.dA = webix.event(document.body, webix.env.mouse.move, this.eA, {
                    bind: this
        ...
        eA: function(t) {
            if (this.cA !== !1) {
                ...
                else if (Math.abs(this.cA.x - e.x) < (this.config.minWidth || 100) || Math.abs(this.cA.y - e.y) < (this.config.maxHeight || 100)) return;
            ...
            if (e > i && 41 > e) {
                ...
                if (35 == e) s = n.length - 1;
                    ...
                    for (var r = 37 === e || 38 === e ? -1 : 1, a = 0; a < n.length; a++)
                        if ("0" == n[a].getAttribute("tabindex")) {
        ...
        Ce: !0,
        De: function() {
            this.Ce && (this._E || webix.UE(this.getInputNode(), "change", this.Xy, {
                bind: this
    ...
    webix.protoUI({
        ...
        Je: function() {
            ...
            if (t.suggest) t.popup = t.suggest;
                ...
                t.popup = t.suggest = this.suggest_setter({
                    ...
                    padding: 0,
                    body: {
                        multiselect: this.s.multiselect,
                        timepicker: e,
                        type: this.s.type,
                        icons: this.s.icons
                    }
        ...
        validate: function(t, e) {
            ...
            if ((n || h) && !e && this.getValues && (e = this.getValues()), n) {
                ...
                var u = n.$all,
                    f = e;
                if (this.s.complexData && (f = webix.CodeParser.collapseNames(e)), u)
                    for (var b in e)
                        if (!l[b]) {
    ...
    webix.rules = {
        ...
        importData: function(t, e) {
            ...
            if (this.jf = null, "function" == typeof i.serialize) {
                ...
                var a, o;
                if (webix.isArray(t))
                    for (var n = 0; n < t.length; n++) o = a = t[n], "object" == typeof o ? o.id = o.id || webix.uid() : o = {
                            id: a,
                            value: a
                        }, this.order.push(o.id),
                        this.qf && this.qf(o), this.pull[o.id] = o;
                else
                    for (var n in i) this.order.push(n), this.pull[n] = {
                        id: n,
                        value: i[n]
                    }
            }
    ...
    webix.Scrollable = {
        $init: function(t) {
            ...
            }, "")), this.y = (this.y || this.w).firstChild, void(webix.env.touch && "native" !== webix.env.touch || webix.UE(this.x, "scroll", webix.bind(function(t) {
    ...
    webix.protoUI({
                ...
                if (!webix.isArray(t)) {
                    if (this != i || s.copy) {
                        ...
                        var c = this.data.branch[h.$parent],
                            d = webix.PowerArray.find.call(c, t);
            ...
            for (var r = [], a = n.level && n.level != s, o = 0; o < i.length; o++) {
                ...
                if (a) c = !0;
                    ...
                    if (r.push(h), n.openParents !== !1)
                        for (var u = this.getParentId(h); u && "0" != u;) this.getItem(u).open = 1,
        ...
        eachChild: function(t, e, i, s) {
            ...
            var r = n[t];
            if (r)
                for (var a = 0; a < r.length; a++) r[a] && e.call(i || this, this.getItem(r[a]))
        },
            ...
            if (h != this.Yg) {
                ...
                if (l && l == this) {
                    ...
                    if (this.XC = !0, c) {
                        if (c != this.Yg) {
                            if (c != d) {
                                ...
                                this.getBranchIndex ? (u = {
                                    ...
                                    }, f = this.getBranchIndex(c)) : (u = {}, f = this.getIndexById(c)),
                        ...
                        if (!this.callEvent("onBeforeDropOrder", [d, -1, e, {
                                parent: 0
                            }])) return;
                        this.Yg = c
                    }
        ...
        group: function(t) {
            ...
            var e = "function" == typeof t.by ? "value" : t.by,
                i = this.ih(t.by);
        ...
        init: function() {
            return null !== this.nh ? this.nh : (webix.destructors.push({
                    obj: this
                }), this.nh = document.createElement("textarea"), this.nh.className = "webix_clipbuffer", this.nh.setAttribute("webixignore", 1),
        ...
        moveSelection: function(t, e, i) {
            ...
            if (!s.disabled) {
                var n = this.getSelectedId(!0),
                    r = this.count && ("x" == s.layout || s.xCount > 1);
                ...
                if (1 == n.length) {
                    ...
                    if (this.OD && (n = this.OD(n, o, t)), this.showItem(n), this.select(n), this.getSubMenu && this.getSubMenu(n) && this.Yq(n, this.getItemNode(n)), !this.config.clipboard && i !== !1) {
        ...
        VF: function(t, e, i) {
            ...
            for (var d = 0; d < this.data.order.length;) {
                ...
                if (n = parseInt(d / o), r = d - n * o, u && r >= i) {
                    ...
                    var f = this.type.template(u, this.type),
                        b = this.YF,
                        x = {
                            display: "table-cell",
    ...
    function() {
        ...
        Ai: function(t, e) {
            ...
            for (var s = i.R; s <= i.Ji;) {
                ...
                for (var c = {
                        $template: "Loading"
                    }, d = 0; d < l.length; d++) l[d] || this.Bi.push(a + d), l[d] = this.jb(l[d] || c);
                h.innerHTML = l.join("");
                for (var d = 0; d < l.length; d++) this.t[this.data.getIdByIndex(a + d)] = h.childNodes[d];
                var u = parseFloat(r.style.height, 10),
                    f = (s - n) * i.Ei,
                    b = u - f - i.Ei;
    ...
    webix.DataDriver.htmltable = {
        ...
        Mj: function(t, e) {
            for (var i = 0, s = 0; s < this.fj.length; s++) {
                ...
                for (var r = 0; r < n.length; r++) "object" != typeof n[r] && (n[r] = {
                    text: n[r]
                }), n[r] && n[r].height && (e[r] = n[r].height), n[r] && n[r].autoheight && (e[r] = this.RF(n[r], this.fj[s], s));
        ...
        Kv: function(t) {
            ...
            for (var a = this.Xj(), o = 0; o < this.fj.length; o++) {
                ...
                if (o < this.Fj && o >= this.s.leftSplit && (o < a[0] || o > a[1]) && (h.qk = -999), h.attached && h.node) {
                    var l = h.node.childNodes[i],
                        c = this.Ek(e, this.fj[o], 0);
        ...
        yD: function(t, e, i, s, n) {
            ...
            if (o) {
                ...
                if (s.single && o.$row && (this.Dk = !0, this.wk.push({
                        top: s.total,
                        id: o.id,
                        index: t
                    }), !o.$sub)) {
                ...
                var r = this.Ek(o, e, t),
                    d = this.Mv(e, r, o, a); - 1 !== d.indexOf("select") && (l += " aria-selected='true' tabindex='0'");
                var u = !!o.$subopen,
                    f = u ? "margin-bottom:" + o.$subHeight + "px;" : "";
            ...
            if (null === t && this.data.order.length > 0 && (t = this.data.order[0]), null === e && (e = this.columnId(0)), null === i && (i = this.data.order.length), null === s && (s = this.s.columns.length), this.exists(t) && (t = this.getIndexById(t), e = this.getColumnIndex(e), null !== e))
                for (var a = 0; i > a && t + a < this.data.order.length; a++) {
                    var o = t + a,
                        h = this.data.order[o];
                    if (h)
                        for (var l = this.getItem(h), c = 0; s > c && e + c < this.s.columns.length; c++) {
                            var d = e + c,
                                u = this.columnId(d),
                                f = n(l[u], h, u, a, c);
                            r || (l[u] = f)
    ...
    webix.extend(webix.ui.datatable, {
        ...
        _k: {
            ...
            cell: {
                ...
                selectRange: function(t, e, i, s, n) {
                    ...
                    this.Dg = !0;
                    for (var c = r; a >= c; c++)
                        for (var d = o; h >= d; d++) this.select(this.getIdByIndex(c), this.columnId(d), n);
                    this.Dg = !1, this.jl()
                }
            },
            column: {
        ...
        pA: function(t, e) {
            ...
            }, this)), this.callEvent("onSubViewCreate", [i, t])), this.qA(t, i || webix.$$(s))
        },
        rA: function(t) {
            var e = this.getItem(t),
        ...
        $init: function(t) {
            ...
            this.Cl = "x" == e ? "left" : "top", this.x = webix.html.create("DIV", {
                ...
                }), webix.UE(this.x, webix.env.mouse.down, webix.html.stopEvent),
                ...
                }), t[s] && (this.El.style[s] = t[s] + (t.border ? 1 : 0) + "px", this.Dl.style[s] = t[s] + "px"),
                t.cursor && (this.Dl.style.cursor = this.El.style.cursor = this.x.style.cursor = t.cursor), this.Fl = webix.event(i, webix.env.mouse.move, this.Gl, {
                    bind: this
                }), this.Hl = webix.event(document.body, webix.env.mouse.up, this.Il, {
                    bind: this
                }), this.Dl.style[this.Cl] = this.El.style[this.Cl] = t.start + "px", i.appendChild(this.x),
    ...
    function() {
        ...
        var i = webix.Touch = {
            ...
            $init: function() {
                i.$init = function() {}, webix.event(document.body, s.down, i.dm), webix.event(document.body, s.move, i.em), webix.event(document.body, s.up, i.fm),
            ...
            if ("data" != e)
                for (var a = 0; a < i.header.length; a++) {
                    ...
                    if (o) {
                        var h = 0;
                        if (o.rotate)
                            for (var l = 0; l < (o.rowspan || 1); l++) h += this.Mt[l];
        ...
        adjustRowHeight: function(t, e) {
            if (t) {
                ...
                var r = new Array(this.data.order.length),
        ...
        hideColumn: function(t, e, i, s) {
            ...
            if (e = e || {}, s !== !1) {
                ...
                if (-1 == l) return;
                if (this.rz(), e.spans)
                    for (var c = r[l].header, d = 0; d < c.length; d++) c[d] && (c[d].$groupSpan = c[d].colspan || 1, h = Math.max(h, c[d].$groupSpan));
                ...
                if (e.spans)
                    for (var c = n.header, d = 0; d < c.length; d++) c[d] && (c[d].colspan = c[d].$groupSpan || c[d].colspan,
        ...
        showColumnBatch: function(t, e) {
            ...
            e = e !== !1, this.eachColumn(function(s, n) {
                if (n.batch) {
                    var r = this.am[n.id];
                    e || (r = !r),
                        n.batch == t && r ? this.hideColumn(n.id, {
                            spans: !0
                        }, !0, !e) : i || n.batch == t || r || this.hideColumn(n.id, {
                            spans: !0
                        }, !0, e)
                }
            }, !0), this.On()
        ...
        moveSelection: function(t, e, i) {
            if (!this.s.disabled) {
                ...
                if (n >= 0) {
                    var a = s[n].row,
                        o = s[n].column;
                    if ("top" == t || "bottom" == t) a && ("top" == t ? a = this.data.getFirstId() : "bottom" == t && (a = this.data.getLastId())), o && (n = 0, "bottom" == t && (n = this.config.columns.length - 1), o = this.columnId(n));
        ...
        nG: function(t, e, i) {
            if (this.isColumnVisible(t)) {
                var s = this.getColumnIndex(t),
                    n = this.s.leftSplit > s ? 0 : this.Fj <= s ? 2 : 1;
                e = e || 0;
                var r = i.childNodes[n].getElementsByTagName("TR");
                if (r.length)
                    for (var a = r[e + 1].childNodes, o = 0; o < a.length; o++)
                        if (a[o].getAttribute("column") == s) return a[o].firstChild
            }
            return null
        },
    ...
    function() {
        ...
        t.prototype.draw = function(t, e, i) {
            ...
            var f = this.KC(t, e, i),
                b = [];
            for (s = 0; s < f.length; s++) r = f[s], b.push(u.getRect(r.x, r.y, r.width, r.height, "webix_sparklines_event_area ", {
                webix_area: s
            }));
            ...
            if (e = (e || 100) - 2 * n, i = (i || 100) - 2 * r, t.length)
                for (var a = e / t.length, o = 0; o < t.length; o++) s.push({
                    x: Math.ceil(a * o) + n,
                    y: r,
                    height: i,
                    width: a
        ...
        t.prototype.rC = 0, t.prototype.qC = ["#f55b50", "#ff6d3f", "#ffa521", "#ffc927", "#ffee54", "#d3e153", "#9acb61", "#63b967", "#21a497", "#21c5da", "#3ea4f5", "#5868bf", "#7b53c0", "#a943ba", "#ec3b77", "#9eb0b8"], t.prototype.xv = function(t, e) {
            ...
            for ("function" != typeof h && (h = function() {
                ...
                a += c.getSector({
                    x: f,
                    y: b
                }, u, l[r][0], l[r][1], "webix_sparklines_sector", s);
            for (n = c.group(a), a = "", r = 0; r < l.length; r++) a += c.getSector({
                x: f,
                y: b
            }, u, l[r][0], l[r][1], "webix_sparklines_event_area", {
                webix_area: r
            });
    ...
    function() {
                ...
                o.forEach(webix.bind(function(t, r) {
                    for (var o = e[r + n], c = 0; c < o[i].length; c++) {
                        ...
                        if (d || s[a] && s[a][c]) {
                            if (d = webix.copy(d || {
                                    text: ""
                                }), s[a] && s[a][c] && 0 === r && (d.colspan = s[a][c], s[a][c] = 0), d.colspan) {
                        ...
                        if (s[x]) {
                            ...
                            if ("selection" !== t.data || "selection" == t.data && -1 !== this.sq(n, function(t) {
                                ...
                                if (!v || v && v[0] == e && v[1] == p) {
                                    ...
                                    $inspan: !0
                                }), a = Math.max(w + 1, a), o = Math.max(u + 1, o))
                            }
                        }
        ...
        $exportView: function(t) {
            if (this.isBranchOpen && webix.extend(t, {
                    filterHTML: !0
        ...
        oG: function(t) {
            var e = this.config.columns,
                i = [];
            return this.pG = this.pG || {}, t.docHeader && (i = [{
                0: this.qG(t.docHeader.css)
            }, {
                0: {}
            }]), t.header !== !1 && (i = this.rG(t, "header", i)), this.data.each(function(t) {
                for (var s = {}, n = 0; n < e.length; n++) {
                    var r = this.getCss(t.id, e[n].id),
                        a = e[n].node.className,
                        o = "",
                        h = this.getIndexById(t.id) % 2 ? "even" : "odd",
                        l = null,
                        c = null;
        ...
        sG: function(t, e) {
            ...
            s.font.name = i["font-family"].replace(/,.*$/, ""), s.font.sz = .75 * i["font-size"].replace("px", ""), s.font.color = {
                    rgb: webix.color.rgbToHex(i.color)
                }, "normal" !== i["font-weight"] && (s.font.bold = !0), "underline" === i["text-decoration-line"] && (s.font.underline = !0),
            ...
            return n && (s.fill = {
                ...
                }), -1 !== i["background-image"].indexOf("gradient") && (s.fill = {
                    fgColor: {
                        rgb: webix.color.rgbToHex(i["background-image"].substring(i["background-image"].lastIndexOf("(")))
                    }
                }), t.parentNode && "TD" == t.parentNode.nodeName && (i = this.tG(t.parentNode)),
                "0px" !== i["border-right-width"] && (s.border.right = {
                    style: "thin",
                    color: {
                        rgb: webix.color.rgbToHex(i["border-right-color"])
                    }
                }), "0px" !== i["border-bottom-width"] && (s.border.bottom = {
                    style: "thin",
                    color: {
                        rgb: webix.color.rgbToHex(i["border-bottom-color"])
                    }
                    ...
                    style: "thin",
                    color: {
                        rgb: webix.color.rgbToHex(i["border-top-color"])
                    }
                }), this.pG[e] = s, s
        },
        qG: function(t) {
    ...
    webix.Canvas = webix.proto({
        ...
        hide: function(t, e, i) {
            if (t.querySelectorAll)
                for (var s = t.querySelectorAll('area[userdata="' + e + '"]'), n = 0; n < s.length; n++) {
                    var r = s[n];
        ...
        render: function(t, e, i) {
            ...
            if (this.isVisible(this.s.id) && (e = this.oo(), this.callEvent("onBeforeRender", [e, i]))) {
                ...
                if (this.s.legend && (this.canvases.legend || (this.canvases.legend = this.lo("legend")),
                    ...
                    for (n = 0; n < this.go.length; n++) this.s = this.go[n], this.canvases[n] || (this.canvases[n] = this.lo(this.name + " " + n, "z-index:" + (2 + n), null, n, this.s.ariaLabel)), this["$render_" + this.s.type](this.canvases[n].getCanvas(), e, s.start, s.end, n, r);
        ...
        oo: function() {
            ...
            if (s = this.data.getRange(), t = -1 != this.s.type.toLowerCase().indexOf("barh") ? "yAxis" : "xAxis", e = this.s[t], e && e.units && "object" == typeof e.units) {
                ...
                if (r = [], o.length) {
                    ...
                    for (n = 0; n < o.length; n++) "undefined" != typeof l[o[n]] ? (s[l[o[n]]].$unit = o[n], r.push(s[l[o[n]]])) : r.push({
                        $unit: o[n]
                    })
                }
                return r
        ...
        Ao: function(t, e) {
            ...
            var n, r, a;
            if (n = this.uG((e - t) / 8 || 1), n > Math.abs(t)) r = 0 > t ? -n : 0;
            else {
                var o = Math.abs(t),
                    h = Math.floor(this.Do(o)),
                    l = o / Math.pow(10, h);
        ...
        Go: function(t, e) {
            ...
            else if (i = webix.GroupMethods.max(this.go[0][e], n),
                s = r && "undefined" != typeof r.start ? parseFloat(r.start) : webix.GroupMethods.min(this.go[0][e], n), this.go.length > 1)
        ...
        mo: function(t, e) {
            ...
            if (t = t || [], e = e || this.bc, l = this.canvases.legend.getCanvas(), s = this.s.legend, h = "x" != this.s.legend.layout ? "width:" + s.width + "px" : "", this.ko && (this.ko.innerHTML = "", this.ko.parentNode.removeChild(this.ko)), this.canvases.legend.clearCanvas(!0),
                ...
                for (i = 0; i < t.length; i++) a.push(this.Jo(n, s.template(t[i]), t[i].id));
        ...
        No: function(t) {
            ...
            if (this.s.yAxis && "undefined" != typeof this.s.yAxis.end && "undefined" != typeof this.s.yAxis.start && this.s.yAxis.step) s = parseFloat(this.s.yAxis.end), n = parseFloat(this.s.yAxis.start);
                ...
                for (e = 0; e < t.length; e++)
                    for (t[e].$sum = 0, t[e].$min = 1 / 0, i = 0; i < this.go.length; i++) r = Math.abs(parseFloat(this.go[i].value(t[e]) || 0)),
        ...
        Oo: function(t, e, i, s, n, r, a, o) {
            ...
            return "light" == r ? (h = "x" == o ? t.createLinearGradient(e, i, s, i) : t.createLinearGradient(e, i, e, n),
                f = [
                    ...
                    [.9, a],
                    [1, a]
                ], l = 2) : "falling" == r || "rising" == r ? (h = "x" == o ? t.createLinearGradient(e, i, s, i) : t.createLinearGradient(e, i, e, n), c = webix.color.toRgb(a), d = webix.color.rgbToHsv(c[0], c[1], c[2]), d[1] *= .5, u = "rgb(" + webix.color.hsvToRgb(d[0], d[1], d[2]) + ")", "falling" == r ? f = [
                    [0, u],
                    [.7, a],
                    [1, a]
                ] : "rising" == r && (f = [
                ...
                l = 0) : (t.globalAlpha = .37, l = 0, h = "x" == o ? t.createLinearGradient(e, n, e, i) : t.createLinearGradient(e, i, s, i), f = [
                [0, "#9d9d9d"],
                [.3, "#e8e8e8"],
                [.45, "#ffffff"],
                [.55, "#ffffff"],
    ...
    webix.extend(webix.ui.chart, {
        ...
        Zo: function(t, e, i, s, n, r, a, o) {
            ...
            if (h) {
                ...
                var p = (e + Math.floor((i + x) * Math.sin(d))) * r + f,
                    w = t + Math.floor((i + c / 2) * Math.cos(d)) + u,
                    v = n < Math.PI / 2 + .01,
                    g = s < Math.PI / 2;
        ...
        $render_bar: function(t, e, i, s, n, r) {
            ...
            for (S && "function" != typeof S ? (C = S, S = !1) : S && (S = t.createLinearGradient(0, s.y, 0, i.y), this.s.gradient(S)), w || this.zo(t, i.x, s.y + .5, s.x, s.y + .5, "#000000", 1),
                ...
                var I = i.x + _ + h * o + (a + 1) * y,
                    E = s.y,
                    M = S || this.s.color.call(this, e[h]),
                    A = this.s.border ? 1 : 0,
                    D = this.s.label(e[h]);
        ...
        bp: function(t, e, i, s, n, r, a, o, h, l, c, d, u) {
            ...
            var f = this.ep(t, i, s, h, o, n, r),
                b = this.fp(t, f.x0, f.y0, n, a, o, f.value, u);
            c && !d && t.lineTo(f.x0 + u, e.y), t.fill(), t.restore();
            var x = f.x0,
                p = f.x0 != i ? i + b[0] : b[0],
                w = f.x0 != i ? f.start - b[1] - f.y0 : f.y0,
        ...
        cp: function(t, e, i, s, n, r, a, o, h, l, c) {
            t.save();
            var d = this.ep(t, e, i, o, a, s, n),
                u = this.Oo(t, d.x0, d.y0, d.x0 + s, d.y0 - a * d.value + 2, l, h, "y");
    ...
    webix.extend(webix.ui.chart, {
        $render_line: function(t, e, i, s, n, r) {
            ...
            if (l = this.hp(t, e, i, s, n), a = this.s, e.length) {
                for (c = a.offset ? i.x + .5 * l.cellWidth : i.x, h = [], o = 0; o < e.length; o++)
                    if (w = this.ip(e[o], i, s, l), w || "0" == w) {
                        if (u = o ? l.cellWidth * o - .5 + c : c, b = "object" == typeof w ? w.y0 : w, o && this.s.fixOverflow) {
                            ...
                            d = l.cellWidth * (o - 1) - .5 + c, f = "object" == typeof p ? p.y0 : p, p.out && (x = "min" == p.out ? s.y : i.y, h.push({
                                x: this.jp(d, u, f, b, x),
                                y: x
                            })), w.out && (x = "min" == w.out ? s.y : i.y, h.push({
                                x: this.jp(d, u, f, b, x),
                                y: x
                            }))
                        }
        ...
        $render_barH: function(t, e, i, s, n, r) {
            ...
            for (h = (s.y - i.y) / e.length, u = this.Go("h"), f = u.max, b = u.min, y = s.x - i.x, k = !!this.s.xAxis, n || this.mp(t, e, i, s, b, f, h), k && (f = parseFloat(this.s.xAxis.end), b = parseFloat(this.s.xAxis.start)), g = this.Ho(b, f), w = g[0], p = g[1], $ = w ? y / w : 10, k || (m = 10, $ = w ? (y - m) / w : 10), o = parseInt(this.s.barWidth, 10),
                ...
                d = 0; d < e.length; d++)
                if (_ = parseFloat(this.s.value(e[d] || 0)), this.Bo && (_ = this.Do(_)), _ && !isNaN(_))
                    if (_ > f && (_ = f), _ -= b, _ *= p, C = i.x, S = i.y + a + d * h + (o + 1) * n, 0 > _ && "auto" == this.s.origin || this.s.xAxis && 0 === _ && !("auto" != this.s.origin && this.s.origin > b)) this.canvases[n].renderTextAt("middle", "right", C + 10, S + o / 2 + a, this.s.label(e[d]));
                    else {
        ...
        pp: function(t, e, i, s, n, r, a, o, h, l) {
            ...
            var c = this.tp(t, e, i, o, a, s, n),
                d = this.Oo(t, c.x0, c.y0 + s, c.x0 + a * c.value, c.y0, l, h, "x");
        ...
        $render_area: function(t, e, i, s, n, r) {
            ...
            if (d = this.hp(t, e, i, s, n), o = this.s, l = o.eventRadius || Math.floor(d.cellWidth / 2), e.length) {
                for (u = [], x = o.offset ? i.x + .5 * d.cellWidth : i.x, h = 0; h < e.length; h++)
                    if (c = e[h], b = this.ip(c, i, s, d), v = x + d.cellWidth * h, b) {
        ...
        $render_splineArea: function(t, e, i, s, n, r) {
            var a, o, h, l, c, d, u, f, b, x, p, w, v, g, m = this.s,
                y = [];
    ...
    function() {
        ...
        Xp: function(t, e, i) {
            for (var s = this.s, n = "", r = webix.Date.datePart(webix.Date.copy(i.Rp)), a = s.weekNumber ? 1 : 0, o = webix.Date.getISOWeek(webix.Date.add(r, 2, "day", !0)), h = (this.s.minDate || new Date(1, 1, 1),
                ...
                for (var l = a; l < t.length; l++) {
                    var c = this.Zp(r, i),
                        d = this.s.dayTemplate.call(this, r),
                        u = this.VG(r),
                        f = "";
        ...
        on_click: {
            ...
            webix_cal_day: function(t, e, i) {
                var s = this.gF(i),
                    n = "touch" === this.s.multiselect || t.ctrlKey || t.metaKey;
                this.zt(s, n)
            },
        ...
        selectDate: function(t, e, i) {
            if (t && i && this.config.multiselect || (this.UG = {}), t) {
                ...
                for (var s = 0; s < t.length; s++) {
                    var n = this.Jp(t[s]),
                        r = webix.Date.datePart(webix.Date.copy(n)).valueOf();
    ...
    webix.protoUI({
        ...
        ut: function() {
            ...
            if (e = s.length, i.tabMinWidth && r > n / e) return {
                max: parseInt(n / r, 10) || 1
            };
            if (!i.optionWidth)
                        ...
                        if (b)
                            if (u.max) {
                                ...
                                for (n = 0; n < l.length && !x; n++)
                                    if (l[n].id == t.value && (x = !0, n + 1 > u.max)) {
                                        var p = l.splice(n, 1),
                                            w = l.splice(0, u.max - 1).concat(p);
                                        l = w.concat(l)
                                    }
            ...
            pc: function() {
                ...
                for (var r = 0; r < n.length; r++) {
                    ...
                    if (o) {
                        ...
                        this.elements[o] = a, a.getValue = i, a.setValue = s, a.Ce = !c, a.s = {
    ...
    function() {
        ...
        webix.protoUI({
            ...
            wG: function() {
                ...
                var e = this.fj && this.fj.length ? this.fj : this.yG(),
                    i = [];
            ...
            tooltip_setter: function(t) {
                ...
                return this.s.chart.tooltip = webix.extend(e || {}, {
                    isHtml: !0
                }), webix.template(t);
            },
            $setSize: function(t, e) {
            ...
            yG: function(t) {
                var e = this.s.columns || [],
                    t = this.data.pull[this.data.order[0]];
                if (!e.length && t)
                    for (var i in t) "id" !== i && e.push(i);
                for (var s = 0; s < e.length; s++) "object" != typeof e[s] && (e[s] = {
                    type: this.zG(t, e[s]),
                    label: e[s]
                });
                return this.s.tooltip && e.push({
                        type: "string",
                        role: "tooltip",
                        p: {
                            html: !0
    ...
    function() {
        ...
        html5: {
            ...
            send: function(t) {
                ...
                var h = webix.extend(n.formData || {}, o),
    ...
    function() {
        ...
        webix.env.touch && (webix.ui.orientation = !!((webix.isUndefined(window.orientation) ? 90 : window.orientation) % 180), webix.event(window, "onorientationchange" in window ? "orientationchange" : "resize", t)), webix.env.isFF && window.matchMedia && (window.matchMedia("(orientation: portrait)").addListener(function() {
            ...
            if (webix.env.touch) {
                ...
                var e = document.body.offsetHeight || document.body.scrollHeight,
                    ...
                    s = (-1 != navigator.userAgent.indexOf("iPad"),
        ...
        defaults: {
            ...
            template: function(t, e) {
                var i = e.qs = "x" + webix.uid(),
                    ...
                    a = "<div class='webix_slider_right'></div>",
        ...
        oe: function() {
            ...
            if (t) {
                ...
                var r = Math.ceil((i - 2 * this.mF) * s / n),
                    a = i - 2 * this.mF - r,
        ...
        BG: function(t, e, i, s) {
            ...
            if (this.s.title) {
                ...
                if (r.innerHTML = this.s.title(this.s, this), this.s.moveTitle) {
                    var a = 0;
                    if (n.vertical) a = e + 2 * this.oF - this.nF / 2;
                    else {
                        var o = r.clientWidth / 2,
                            h = o > e ? o - e - 2 * this.oF : 0,
        ...
        tE: function(t) {
            ...
            if (e > 32 && 41 > e) {
                ...
                if (this.My = r ? parseInt(r[1], 10) : -1, r && (s = i.value[this.My]), s = s < i.min ? i.min : s > i.max ? i.max : s, 35 === e) s = i.min;
        ...
        ys: function(t) {
            var e = this.s,
                ...
                r = (e.vertical ? this.dc : this.Ee(e)) - 2 * this.mF,
                a = r ? (t - n) * i / r : 0;
    ...
    function() {
        ...
        function i(t, i) {
            ...
            if (s.heights = {}, o) {
                if (!o.length) {
                    var l = [];
                    for (var c in o) l.push(webix.extend({
                        id: c
                    }, webix.extend({}, o[c])));
                    o = l
                }
            } else if (a) o = [].concat(t.fj);
            else {
                o = [];
                var d = t.data.pull[t.data.order[0]];
                for (var c in d) "id" !== c && "$" != c[0] && o.push({
                    id: c
                })
            }
            if (i.ignore)
                for (var u = o.length - 1; u >= 0; u--) i.ignore[o[u].id] && o.splice(u, 1);
            if (i.id && s.push({
                    id: "id",
                    width: 50,
                    header: " ",
            ...
            for (var v = 0; v < o.length; v++) {
                ...
                if (!g.noExport) {
                    ...
                    "string" == typeof m.header ? m.header = [{
                        text: m.header
                    }] : m.header = webix.copy(m.header);
        ...
        function s(t, e, i) {
            var s, n, r = !!e.filterHTML,
                a = /<[^>]*>/gi,
                o = [];
            if ("excel" === e.export_mode && e.docHeader && (o = [
                        [(e.docHeader.text || e.docHeader).toString()],
                        [""]
                    ],
                    e.docHeader.height && (i.heights[0] = e.docHeader.height)), e.header !== !1 && i.length)
            ...
            if (t.data.each(function(s) {
                ...
                for (var u = i[0].footer ? i[0].footer.length : 0, f = 0; u > f; f++) {
            ...
            return "excel" === e.export_mode && e.docFooter && (o = o.concat([
                    [],
                    [(e.docFooter.text || e.docFooter).toString()]
                ]),
            ...
            if (i) {
                if (e.header !== !1 && (n = o(t, e, "header", n)), s) {
                    ...
                    for (var h in s) {
                        var l = s[h];
                        for (var c in l) {
                            var d = t.getColumnIndex(c) - r,
                                u = t.getIndexById(h) - a,
                                f = d + l[c][0] - 1,
                                b = u + (l[c][1] - 1);
                            n.push({
                                s: {
        ...
        function o(t, e, i, s) {
            for (var n = t.config.columns, r = (e.docHeader ? 2 : 0) + ("header" == i ? 0 : (e.header !== !1 ? t.Mt.length : 0) + t.count()), a = 0; a < n.length; a++)
                for (var o = n[a][i], h = 0; h < o.length; h++) o[h] && (o[h].colspan || o[h].rowspan) && s.push({
                    s: {
                        c: a,
                        r: h + r
                    },
        ...
        function u(t, e, i, s) {
            ...
            if (h)
                for (var f = webix.extend(i.header, {
                    ...
                    for (var b = u.tr(f), x = 0; x < t.length; x++) b.td(t[x].header[a].toString());
            for (var p = 0; p < e.length; p++)
                for (var w = u.tr({}), v = 0; v < e[p].length; v++) w.td(e[p][v]);
            if (l)
                for (var g = webix.extend(i.footer, {
                    ...
                    for (var m = u.tr(g), x = 0; x < t.length; x++) m.td(t[x].footer[a].toString());
            if (i.docFooter !== !1) {
                var y = o.footer();
                y.text({
                    color: 6710886,
            ...
            if (i.docHeader && ("string" == typeof i.docHeader && (i.docHeader = {
                        text: i.docHeader
                    }),
                    webix.extend(i.docHeader, {
                        ...
                        textAlign: "right",
                        order: 0
                    }), _.text = i.docHeader.order), i.docHeaderImage && ("string" == typeof i.docHeaderImage && (i.docHeaderImage = {
                    url: i.docHeaderImage
                }), webix.extend(i.docHeaderImage, {
                    align: "right",
                    order: 1
                ...
                if (!t) {
                    ...
                    o.header({
                        paddingBottom: 10
                    }).image(n, i.docHeaderImage), i.docHeader && _.image < _.text && o.header({
                        paddingBottom: 10
                    }).text(i.docHeader.text, i.docHeader)
                }
                var r = o.render();
                s(r, i)
            });
        ...
        webix.toPNG = function(t, e) {
            ...
            return webix.require(webix.cdn + "/extras/html2canvas.min.js", function() {
                ...
                var s = webix.$$(t);
                if (s && s.$exportView && (s = s.$exportView(e)), !s) return i.reject(f);
            ...
            return webix.require(webix.cdn + "/extras/xlsx.core.styles.min.js", function() {
                ...
                for (var t = {
                    ...
                    var h = n[o].scheme || i(n[o], e),
                        u = n[o].exportData || s(n[o], e, h),
                        b = n[o].spans ? n[o].spans : e.spans ? a(n[o], e) : [],
                        x = n[o].ranges || [],
                        p = n[o].styles || [],
                        w = c(u, h, b, p),
